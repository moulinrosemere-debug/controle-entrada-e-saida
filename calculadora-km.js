...
function calc(){
 ...
 const base=service==='manual' ? km*rate : Number(service||0);
 ...
 const kmValue=service==='manual' ? km*rate : 0;
 ...
 document.getElementById('kmc-summary').value=buildMessage(total,km,rate,base,extraHours,excess,toll,parking);
}
function numberKm(v){return Number(v||0).toLocaleString('pt-BR',{maximumFractionDigits:2})+' km';}
function buildMessage(total,km,rate,base,hours,excess,toll,parking){
